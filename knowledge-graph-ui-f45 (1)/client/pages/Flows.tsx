            ...
            <div className="max-w-5xl mx-auto px-8 py-12">
              ...
              <div className="mt-12 bg-blue-50 border border-blue-200 rounded-lg p-6">
                ...
                <ul className="space-y-2 text-sm text-blue-900">
                  <li>
                    <strong>Blue boxes</strong> are steps in the flow
                  </li>
                  <li>
                    <strong>Concept tags</strong> link to detailed concept pages
                  </li>
                  <li>
                    <strong>Branching</strong> shows decision points or parallel paths
                  </li>
                  <li>
                    <strong>Arrows</strong> show the direction of flow
                  </li>
                </ul>
              </div>
            </div>
